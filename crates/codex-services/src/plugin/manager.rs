...
use crate::PluginMetricsService;
...
use crate::user_plugin::token_refresh::{self, RefreshResult};
...
pub struct PluginManager {
    ...
    plugin_file_storage: Option<Arc<crate::PluginFileStorage>>,
...
impl PluginManager {
    ...
    pub fn with_plugin_file_storage(mut self, storage: Arc<crate::PluginFileStorage>) -> Self {
