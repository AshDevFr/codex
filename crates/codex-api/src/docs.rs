...
#[openapi(
    info(
        title = "Codex API",
        // `CODEX_BIN_VERSION` is wired up in this crate's build.rs by reading
        // the workspace-root Cargo.toml; otherwise this would resolve to the
        // crate's internal `0.0.0` placeholder.
        version = env!("CODEX_BIN_VERSION"),
...
- `/api/v1/events` - SSE event stream"#,
    ...
    paths(
        ...
        v1::handlers::releases::poll_release_sources_now_all,
        v1::handlers::releases::reset_all_release_sources,
    ...
    components(
        schemas(
            ...
            // Strategy types
            codex_models::SeriesStrategy,
            codex_models::BookStrategy,
            codex_models::FlatStrategyConfig,
            codex_models::PublisherHierarchyConfig,
            codex_models::CalibreStrategyConfig,
            codex_models::CalibreSeriesMode,
            codex_models::CustomStrategyConfig,
            ...
            v1::dto::release::PollAllNowResponse,
            v1::dto::release::ResetAllReleaseSourcesResponse,
            ...
            v1::dto::RecordReadingSessionsResponse,
            v1::dto::ReadingSessionDto,
            v1::dto::ReadingSessionKindDto,
            v1::dto::RejectedReadingSessionDto,
            v1::dto::ReadingSessionRejectionReason,
