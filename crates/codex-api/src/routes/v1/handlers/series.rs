...
pub async fn list_series_filtered(
    ...
    use crate::routes::v1::dto::series::{SeriesSortField, SortDirection};
    ...
    let event = EntityChangeEvent {
        event: EntityEvent::SeriesUpdated {
            ...
            fields: Some(vec![
                ...
                "year".to_string(),
                "total_volume_count".to_string(),
                "total_chapter_count".to_string(),
...
pub async fn update_metadata_locks(
    ...
    if let Some(v) = request.total_volume_count {
