...
pub async fn books_to_dtos(
    ...
    let progress_map: HashMap<Uuid, crate::routes::v1::dto::read_progress::ReadProgressResponse> =
        progress_result
    ...
    let dtos = books
        ...
        .map(|book| {
            ...
            BookDto {
                ...
                koreader_hash: book.koreader_hash,
...
pub async fn list_books_filtered(
    ...
    use crate::routes::v1::dto::book::{BookSortField, BookSortParam};
    use crate::routes::v1::dto::series::SortDirection;
