...
impl SeriesRepository {
    ...
    pub async fn update_name(db: &DatabaseConnection, id: Uuid, name: &str) -> Result<()> {
        use crate::repositories::SeriesMetadataRepository;
    ...
    pub async fn delete(db: &DatabaseConnection, id: Uuid) -> Result<()> {
        ...
        use crate::repositories::SeriesDuplicatesRepository;
...
mod tests {
    ...
    use crate::entities::books;
    use crate::repositories::{BookRepository, LibraryRepository, SeriesMetadataRepository};
    ...
    async fn test_create_series() {
        ...
        let metadata = crate::repositories::SeriesMetadataRepository::get_by_series_id(
            db.sea_orm_connection(),
            series.id,
        )
        .await
