...
use crate::entities::{libraries, prelude::*};
...
impl LibraryRepository {
    ...
    pub async fn create(
        ...
        name: &str,
        path: &str,
        _strategy: crate::ScanningStrategy, // Legacy parameter, ignored
    ) -> Result<libraries::Model> {
...
mod tests {
    ...
    async fn test_delete_library_also_deletes_task_metrics() {
        use crate::repositories::task_metrics::{TaskCompletionData, TaskMetricsRepository};
