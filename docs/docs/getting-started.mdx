...
![Setup Wizard - Create Admin Account](./screenshots/02-setup-wizard-step1-filled.png)

3. Optionally configure initial settings (scanner, thumbnails, etc.)

![Setup Wizard - Configure Settings](./screenshots/04-setup-wizard-step2-basic-settings.png)

4. Log in with your new credentials

![Login Screen](./screenshots/52-login-page.png)
...
![Home Page](./screenshots/10-home-with-libraries.png)
