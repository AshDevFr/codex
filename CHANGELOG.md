...
- *(web)* Validate a hand-written filter condition against the field catalog
- *(web)* Add a JSON view of the filter rule, with copy and paste
- *(web)* Show the rule JSON panel under the filter builder

## [2.4.16] - 2026-09-09

### 🐛 Bug Fixes

- *(reader)* Stop a parked tab from clobbering progress read elsewhere

## [2.4.15] - 2026-09-05

### 🔌 API

- *(api)* Honor the sort parameter on unsearched book lists
...
- *(ci)* Move the plugin publish jobs to npm 12

## [2.4.11] - 2026-09-03

### 🐛 Bug Fixes

- *(docker)* Use the lockfile in the cross-build image too

## [2.4.10] - 2026-09-03

### 🐛 Bug Fixes

- *(docker)* Install the frontend from the lockfile, not a live re-resolve
...
- *(web)* Keep 8-bit alpha in the favicon's 16px frame

### 📚 Documentation

- Add Codex Reader (iOS) support page and privacy policy

## [2.4.6] - 2026-08-31

### 🚀 Features

- *(web)* Switch the app icon to the ice+ember branding

## [2.4.5] - 2026-08-31

### 🐛 Bug Fixes

- *(stats)* Bucket reading activity by the viewer's day instead of UTC

## [2.4.4] - 2026-08-29

### 🐛 Bug Fixes

- *(reader)* Overlap webtoon pages 1px to stop sub-pixel seams at zero gap

## [2.4.3] - 2026-08-29

### 🚀 Features

- *(web)* Let a reader drop a series reading direction back to the inherited one

## [2.4.2] - 2026-08-29

### 🐛 Bug Fixes

- *(scanner)* Stop losing the renumber pass a book was waiting on
...
- *(api)* Serve the archive entry the page row names, not the one at that index

### 🐛 Bug Fixes

- *(parsers)* Stop dropping AVIF pages at the extension gate
- *(reader)* Stop webtoon pages deadlocking on their own lazy load

### 📚 Documentation

- Document AVIF page support and what the server cannot do with it

### ⚙️ Miscellaneous Tasks

- Lint the crate without default features, which nothing else builds
- Apply the no-default-features lint to main and tag builds too

## [2.2.2] - 2026-08-23

### 🐛 Bug Fixes

- *(changelog)* Remove the duplicate header left by the 2.2.1 release
- *(web)* Make the auth pages follow the color scheme instead of forcing dark
- *(web)* Stop borrowing the book count as a volume or chapter numerator
