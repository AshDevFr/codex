import { AppShell, Stack, NavLink, ActionIcon, Menu, Group, Text, Modal, Button } from '@mantine/core';
import {
  IconHome,
  IconBooks,
  IconSettings,
                    ...
                    <Menu shadow="md" width={200} position="right-start">
                      ...
                      <Menu.Dropdown>
                        <Menu.Item
                          ...
                          onClick={(e: React.MouseEvent) => {
                            e.stopPropagation();
                            scanMutation.mutate({ libraryId: library.id, mode: 'normal' });
                          }}
                        >
                          Scan Library
                        </Menu.Item>
                        <Menu.Item
                          ...
                          onClick={(e: React.MouseEvent) => {
                            e.stopPropagation();
                            scanMutation.mutate({ libraryId: library.id, mode: 'deep' });
                          }}
                        >
                          Scan Library (Deep)
                        </Menu.Item>
