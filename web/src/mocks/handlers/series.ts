...
export const seriesHandlers = [
  ...
  http.get("/api/v1/series/:id/metadata", async ({ params }) => {
    ...
    return HttpResponse.json({
      ...
      totalVolumeCount: seriesItem.bookCount,
  ...
  http.patch("/api/v1/series/:id/metadata", async ({ params, request }) => {
    ...
    return HttpResponse.json({
      ...
      totalVolumeCount: body.totalVolumeCount ?? seriesItem.bookCount,
      totalChapterCount: body.totalChapterCount ?? null,
  ...
  http.put("/api/v1/series/:id/metadata/locks", async ({ params, request }) => {
    ...
    return HttpResponse.json({
      ...
      totalVolumeCount: body.totalVolumeCount ?? false,
      totalChapterCount: body.totalChapterCount ?? false,
